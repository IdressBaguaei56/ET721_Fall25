...
def check_guess(random_number):
    GUESS_NUMBER = 7  # constant guess number
...
# Example usage
random_num = generate_random(1, 10)  # random number between 1 and 10
print("Random number generated:", random_num)  # just to see the number
